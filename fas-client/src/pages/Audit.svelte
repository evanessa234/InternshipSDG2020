<script>
  ...
  let unsubCourse, unsubAudit, course, audit;
  let toCreate;
  onDestroy(() => {
    courseStore.set({});
    unsubCourse;
          ...
          <div class="dqa">
            <div class="md:px-2">
              ...
              <textarea
                ...
                placeholder="Drop suggestions or corrections here"
              ...
              {#if $isLab}
              <Title text={' Experiment List or Lab Plan'} />
              {:else }
              <Title text={'Lesson Plan'} />
              {/if}
              <div class="flex justify-between">
                Is syllabus covered within timeline of IA?
                <div>
                  <input
                    class="self-center"
                    type="radio"
              ...
              {#if $isLab}
                <div class="flex justify-between">
                  Satisfied with each experiment's weightage?
                  <div>
                    <input
                      class="self-center"
                      type="radio"
              ...
              <div class="flex justify-between">
                Is time limit justified for each experiment?
                <div>
                  <input
                    class="self-center"
                    type="radio"
              ...
              Question Quality:
                <input
                  class="self-center"
                  type="radio"
                  bind:group={$dqaStore.questionQuality}
                  value={'Logical'} />
                <label>Logical</label>
                <input
                  class="self-center"
                ...
                <input
                  ...
                  bind:value={$dqaStore.questionQuality} />
